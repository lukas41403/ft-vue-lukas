    ...
    <div class="text-gray-600 body-font border-t-[1px] border-[rgb(231,231,231)]">
        ...
        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              ...
              <li>
                <router-link to="/stlpove" class="text-gray-600 hover:text-gray-800">Stĺpové osvetlenie</router-link>
              </li>
              <li>
                <router-link to="/retaze" class="text-gray-600 hover:text-gray-800">LED reťaze</router-link>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div class="bg-bg_footer">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p class="text-gray-500 text-sm text-center sm:text-left">© 2025 - Lukáš Čepilek</p>
